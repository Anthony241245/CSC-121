...
def calculate_tuition_all_students():
    ...
    for student in stu_names:
        print(f"Getting tuition for {student}:")
        student_tuition = 0
        for i in range(len(courses)):
...
def calculate_tuition_specific_student():
    ...
    if student_name:
        print(f"Getting tuition for {student_name}:")
        student_tuition = 0
        ...
        print("No student selected. Returning to the menu.")
...
def main():
    ...
    while menu_option != 3:
        ...
        if choice == '1':
            ...
            calculate_tuition_specific_student()
        elif choice == '3':
